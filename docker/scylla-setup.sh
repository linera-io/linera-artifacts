...
#
# shellcheck disable=SC2034  # CAN_WRITE is read in messages near the writes.
# shellcheck disable=SC2086  # /proc paths intentionally unquoted (no globbing risk).
# shellcheck disable=SC2002  # `cat | cmd` kept for readability; perf is irrelevant.
